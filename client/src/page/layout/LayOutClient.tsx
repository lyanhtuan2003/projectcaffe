...
const LayOutClient = () => {
    ...
    const totailProduct = JSON.parse(localStorage.getItem('cartItems')!);
    const totalproduct = totailProduct.length

    return (
        <div className='lg:w-[1300px] m-auto'>
            <div className="flex justify-around items-center flex-shrink-0 text-white sm:mb-[30px] px-[20px]">
                            ...
                            <div className="flex flex-1 items-center justify-between gap-8 sm:justify-end">
                                ...
                                {isLoggedIn ? (
                                    <button
                                        ...
                                        type="button"
                                        className="group flex flex-col items-center justify-center gap-1 rounded-lg transition"
                                    >
                                        <img
                                            alt="Man"
                                        ...
                                        />
                                        <p className='text-black sm:text-[14px] text-[11px]'>{customers.user.email}</p>
                                        <button
                                            type="button"
                                            className="text-blue-600 hover:text-blue-700 underline sm:text-[14px] text-[11px]"
                                        >
                                            Logout
                                        </button>
                                    </button>
                ...
                {/* <div>
                    {isLoggedIn ? (
                        <>
                            ...
                            <p className='text-black'> <b className='text-red-600'>hi </b>{customers.user.name}/ <button onClick={handleLogout}>Đăng xuất</button></p>
                        </>
                    ) : (
                        <>
                            <p className='text-black'>
                                <Link to={"/signup"}>đăng ký</Link> / <Link to={"/signin"}>đăng nhập</Link>
                            </p>
                        </>
                    )}
                    <Link to={`product/cart`}><button className='sm:text-[10px] lg:text-[15px] lg:bg-black mt-[10px]  bg-black'>giỏ hàng</button></Link>
                </div> */}
            </div>
            <nav className="px-[20px] mt-[-30px] sm:bg-yellow-900  sm:flex sm:justify-between sm:flex-wrap sm:p-3 sm:text-center ">
                <div className="block sm:hidden">
                    <button

                        onClick={toggleMenu}
                        className="flex items-center px-3 py-2 border rounded  border-black text-black text-[25px] "
                    >
                        <svg
                ...
                <div
                    className={`${menuOpen ? '' : 'hidden'} w-full block flex-grow sm:flex sm:items-center sm:w-auto`}
                >
                    <div className="text-sm sm:flex-grow">
                        <a
                            href="#"
                            className="block mt-4 sm:inline-block sm:mt-0 sm:hover:bg-yellow-900  sm:px-[10px] sm:text-white text-black text-[17px] hover:bg-gray-100 p-[5px]"
                        >
                        ...
                        <a
                            ...
                            className="block mt-4 sm:inline-block sm:mt-0 sm:hover:bg-yellow-900  sm:px-[10px] sm:text-white text-black text-[17px]  hover:bg-gray-100 p-[5px]"
                        >
                            <Link to={"/service"}> Dịch Vụ Nhà Hàng - Khách Sản</Link>
                        </a>
                        <a
                            href="#"
                            className="block mt-4 sm:inline-block sm:mt-0 sm:hover:bg-yellow-900 sm:px-[10px] sm:text-white text-black text-[17px]  hover:bg-gray-100 p-[5px]"
